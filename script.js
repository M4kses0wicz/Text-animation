...
function Cubic_bezier2(){
    spans.forEach(span => {
        span.style.animationTimingFunction = "linear(0 0%, 0.3 8.09%, 0.76 28.68%, 0.99 47.79%, 0.77 76.47%, 1.06 92.65%)";
    });
}
...
function Cubic_bezier4(){
    spans.forEach(span => {
        span.style.animationTimingFunction = "linear(0 0%, 0.11 13.97%, 0.3 18.38%, 0.27 30.88%, 0.35 45.59%, 0.48 55.15%, 0.55 67.65%, 0.74 75.74%, 0.89 83.09%, 1.08 89.71%, 1 100%)";
    });
}
